...
サブスクリプション不要、従量課金制。新規ユーザーには無料クレジット付与。

| モデル | 入力 $/100万トークン | 出力 $/100万トークン | コンテキスト窓 |
|--------|---------------------|---------------------|---------------|
| **MiniMax M2.5**（最新・推奨） | $0.20 | $0.95 | 197K |
| MiniMax-01 | $0.20 | $1.10 | 1.0M |
| MiniMax M2.1 | $0.27 | $0.95 | 197K |
| MiniMax M1 | $0.40 | $1.76 | 1.0M |

### 月額コスト試算（M2.5、1回あたり入力2K + 出力1Kトークン想定）
...
| Claude 3.5 Sonnet（参考） | $3.00 | $15.00 |

**補足**: さらにコストを抑えたい場合、DeepSeek V3.2 は MiniMax の約60%の料金で OpenClaw と互換性あり。
